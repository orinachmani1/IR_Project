...
# without the @post.bgu.ac.il or @gmail.com part
#PROJECT_NAME="IR-3"
...
#gcloud compute scp "gs://205427768/project data/startup_script_gcp.sh" $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
#gcloud compute scp "startup_script_gcp.sh" $GOOGLE_ACCOUNT_NAME@$INSTANCE_NAME:/home/$GOOGLE_ACCOUNT_NAME
#gcloud compute scp "startup_script_gcp.sh" "orinachmani1"@"instance-1":/home/"orinachmani1"
